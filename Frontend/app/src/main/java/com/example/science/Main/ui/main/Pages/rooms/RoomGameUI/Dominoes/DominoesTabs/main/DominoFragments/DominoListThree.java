...
public class DominoListThree extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 4, 8));

        button2.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 5, 10));
        ...
        repository.loadRoomTasksList(link)
                .subscribe(new Observer<List<TaskModel>>() {
                    ...
                    public void onNext(List<TaskModel> taskModels) {
                        ...
                        domino1 = new Domino(arrayList,4, 8, 9);
                        domino2 = new Domino(arrayList,5, 10, 11);
