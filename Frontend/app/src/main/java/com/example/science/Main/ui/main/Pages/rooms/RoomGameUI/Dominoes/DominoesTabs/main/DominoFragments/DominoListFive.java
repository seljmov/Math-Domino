...
public class DominoListFive extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 8, 16));

        button2.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 9, 18));
        ...
        repository.loadRoomTasksList(link)
                .subscribe(new Observer<List<TaskModel>>() {
                    ...
                    public void onNext(List<TaskModel> taskModels) {
                        ...
                        domino1 = new Domino(arrayList,8, 16, 17);
                        domino2 = new Domino(arrayList,9, 18, 19);
