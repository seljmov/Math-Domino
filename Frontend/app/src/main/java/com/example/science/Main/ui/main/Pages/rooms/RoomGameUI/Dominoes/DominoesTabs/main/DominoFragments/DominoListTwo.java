...
public class DominoListTwo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 2, 4));

        button2.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 3, 6));
        ...
        repository.loadRoomTasksList(link)
                .subscribe(new Observer<List<TaskModel>>() {
                    ...
                    public void onNext(List<TaskModel> taskModels) {
                        ...
                        domino1 = new Domino(arrayList,2, 4, 5);
                        domino2 = new Domino(arrayList,3, 6, 7);
