...
public class DominoListSix extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 11, 20));

        button2.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 12, 22));
        ...
        repository.loadRoomTasksList(link)
                .subscribe(new Observer<List<TaskModel>>() {
                    ...
                    public void onNext(List<TaskModel> taskModels) {
                        ...
                        domino1 = new Domino(arrayList,11, 20, 21);
                        domino2 = new Domino(arrayList,12, 22, 23);
