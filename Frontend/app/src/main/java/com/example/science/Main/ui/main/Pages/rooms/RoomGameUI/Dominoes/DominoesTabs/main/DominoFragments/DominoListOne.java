...
public class DominoListOne extends Fragment implements OnBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*
        Observable.just(true).repeatWhen(t->t.delay(1, TimeUnit.SECONDS)).subscribe(b-> {
            if (UPDATE_STATUS) loadTasks(link, gamer);
        });
         */

        button1.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 0, 0));

        button2.setOnClickListener(v -> clickOnDominoButton(link,  gamer, 1, 2));
        ...
        repository.loadRoomTasksList(link)
                .subscribe(new Observer<List<TaskModel>>() {
                    ...
                    public void onNext(List<TaskModel> taskModels) {
                        ...
                        domino1 = new Domino(arrayList,0, 0, 1);
                        domino2 = new Domino(arrayList,1, 2, 3);
